...
{
    /// <inheritdoc />
    public partial class InitialPostgresCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "feed_ingestion_runs",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SourceType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    SourceName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_feed_ingestion_runs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_hazard_reports", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    AccessibilityInfo = table.Column<JsonDocument>(type: "jsonb", nullable: false),
                    SourceSystem = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    SourceRecordId = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceWayId = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    BaseSafetyCost = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    HasCrossing = table.Column<bool>(type: "boolean", nullable: false),
                    IsUnderConstruction = table.Column<bool>(type: "boolean", nullable: false),
                    LightingQuality = table.Column<double>(type: "double precision", nullable: false),
                    IsSteep = table.Column<bool>(type: "boolean", nullable: false),
                    Tags = table.Column<JsonDocument>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_hazard_reports_ReportedAt",
                table: "hazard_reports",
                column: "ReportedAt");

            migrationBuilder.CreateIndex(
                name: "IX_infrastructure_assets_SourceSystem_SourceRecordId",
